...
dd3 <- fread("Table-S5.csv", stringsAsFactors = T)
# p.type:
...
#  9:          Lo-NTCR (L. okamurae)     p1 1.000000000  1.000000000                NS
# 10:          Lo-NTCR (L. okamurae)     p2 0.004761905  0.012987013                 *
# 11:          Lo-NTCR (L. okamurae)     p3 1.000000000  1.000000000                NS
# 12:          Lo-NTCR (L. okamurae)     p4 0.006493506  0.012987013                 *
# 13:    Se-TAR-NTCR (S. erythraeum)     p1 0.523232323  0.697643098                NS
# 14:    Se-TAR-NTCR (S. erythraeum)     p2 0.731313131  0.731313131                NS
# 15:    Se-TAR-NTCR (S. erythraeum)     p3 0.114285714  0.274436674                NS
# 16:    Se-TAR-NTCR (S. erythraeum)     p4 0.137218337  0.274436674                NS
